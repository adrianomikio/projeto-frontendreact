...
// UserArea's components
export const UserAreaMain = styled.main`
display: flex;
flex-direction: row;
height: 474px;
width: 1366px;
justify-content: center;
`
export const UserCommandsSection = styled.section`
height: 408px;
width: 1175px;
border: 0;
border-radius: 26px;
...
export const UserCommandHeader = styled.h1`

`

export const ChangeUserInfoForm = styled.form`
height: 110px;
display: flex;
flex-direction: column;
gap: 4px;
`
export const NewInfoInput = styled.input`
height: 26px;
border: 0;
margin: 0 0 6px 0;
`
export const UserCommandButton = styled.button`
border: 0px;
width: 110px;
margin: 4px;
display: flex;
...
margin: 0 0 6px 0;
`
export const NewProductDescriptionInput = styled.textarea`
height: 68px;
width: 287px;
border: 0;
margin: 0 0 6px 0;
